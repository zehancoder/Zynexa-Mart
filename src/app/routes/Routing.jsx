...
function Routing() {
  return (
    <Routes>
      ...
      <Route path="/shop-now/electronics/smartphones-tablet" element={<SmartPhoneTablet/>}/>
      <Route path="/shop-now/electronics/computers-laptops" element={<ComputerLaptop/>}/>
      <Route path={`/shop-now/electronics/smart-watches`} element={<SmartWatches/>}/>
